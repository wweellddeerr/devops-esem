\section{A Theory on DevOps Adpotion} \label{sec:results}
...
\cat{collaboration culture}, as discussed in the previous section. Based on our understanding, 
implementing the enablers to develop the \cat{collaboration culture} typically leads 
...
concepts related to them either contribute to the level of a \cat{collaboration
...
Based on this first hypothesis, there is no increase in the collaboration
...
\cat{Sharing}, and {\cat{Transparency}.
...
We have realized that the adoption process can follow a
...
can be more efficient than another for creating a \cat{collaboration culture}. For
...
automating everything. What we need is a broader understanding of all task involved from 
conception to production.
Sometimes, we conclude that a given task is not completely necessary and then we
...
\cat{resilience} of the infrastructure and the teams.
...
company did not allowed the continuous deployment of applications in production:
