...
were grouped together in our study within the  \cat{automation} category; and (2) presents
...
\item \textbf{Main Differences:}
  ...
  category: \cat{continuous measurement}; and (3) Does not indicate a major dimension (aka, 
  the core category). 
\end{itemize}
