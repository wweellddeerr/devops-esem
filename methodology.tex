...
We adopted Grounded Theory (GT) as the research method. GT was
...
>>>>>>> d5915e0bf908664b44271fd68b0612651b928b9d
...
%% specify which version of the method the study is built upon.
...
considering \cat{automation} as a core category candidate, because it is a common
wisdom related to DevOps. However, we quickly
realized that the \cat{automation} category did not explain most of the behaviors
...
or events in data. At the same time, we started to understand that
>>>>>>> d5915e0bf908664b44271fd68b0612651b928b9d
