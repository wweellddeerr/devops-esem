...
conformance with human ethics guidelines. The second column presents the role of
each participant in their respective company. The remain columns list the
total years of experience in software development (SWX), years of experience
...
transcription of the first interview. So the results of the analysis of the
first interview was used to evolve the interview script to the second and
so on.
...
the analyze of the fourth interview, we have cogitated automation as core
...
or events in our data. At the same time we started to perceive that the
...
respective memos written during all the process, in the analysis of the tenth
interview, we concluded that it was unequivocal the core role of the
