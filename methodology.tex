...
hereafter we will refer to the participant as P1--P15 (first column). \emph{We assume
a non-disclosure agreement with the investigated companies to use the data only
in the context of our study and therefore we can not disclose them}.
...
The interviews were conducted between April 2017 and April 2018 using Skype calls
with a minimum duration of 20, maximum of 50 and average of 31 minutes.
...
were adequate and the properties of core category were well developed.
