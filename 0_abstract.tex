\begin{abstract}
  ...
  definitions, existing research contributions have tried to
  characterize DevOps.
  ...
  to adopt DevOps. Therefore, the goal of this paper is to present real scenarios of DevOps
  adoption, including a theory, a model and a case study.
  We used the classic Grounded Theory approach to explain and
  characterize scenarios of successful DevOps adoption in 15 companies from different
  ...
  and infrastructure provisioning and management} is enough to achieve DevOps.
   Altogether, our results contribute to (a) generating
