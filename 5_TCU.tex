...
to server logs, and the most controversial of all acitivies: deployment of new versions
...
In addition to delay the software delivering, the silo structure caused a
...
execution of tests and static source code analyser, the development team
...
we present some numbers related to the number of deployments
in production of the most significant systems.\gnote{seria interessante saber
quantas pessoas trabalham nos dois times}
...
% Compras Governamentais & 8 & 2 & 1 \\ \hline
Conecta TCU & 42 & 51 & 39  \\ \hline
e-Cautelares & 9 & 12 & 47  \\ \hline
% e-Denuncia & 31 & 0 & 26 \\ \hline
% e-Representação & 33 builds & 0 & 26 \\ \hline
...
% PessoaTCU & 23 & 1 & 127 \\ \hline
% PessoaRFB & 7 & 0 & 3 \\ \hline
% Protocolo Eletrônico & 19 & 0 & 35 \\ \hline
Siga & 12 & 17 & 55 \\ \hline
...
was that when a developer needed tools like these consensus
%, inherent in his work and necessary to adequately address specific problems,
he depended on opening a
request for the operations team to provide it, with deadlines that often make
the use of the most adequate solution unfeasible\gnote{nao entendi. demora demais?}. With VM provisioning and
