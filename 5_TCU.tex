...
kind of cultural resistance has been to make everyone aware that: (1) fortifying
the collaboration will bring benefits to all involved and especially to the TCU
and (2) following a model builded upon well succeeded experiences is a low-risk
strategy for TCU to explore the benefits of DevOps.
...
Then, the use of multidisciplinary pipelines in the most recent applications
}
