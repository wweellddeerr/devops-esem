...
The \cat{sharing} category represents the grouping of concepts
...
stories about \cat{knowledge sharing} as part of DevOps adoption.
...
\cat{Transparency} contains concepts that are also commonly used to develop the
...
In previous sections, we presented the concepts related to sharing category. In
