...
DevOps practices, including \cat{automation}, \cat{sharing}, and \cat{transparency};
...
Nevertheless, to generate value to business, the mere quickly and successfully
...
\cat{collaboration culture}. The use of \textbf{infrastructure as code} was
...
Previously, we presented the concepts related to the \cat{sharing} category. In
transparency, we also found the concept of \textbf{sharing on a regular basis}, which suggests
that \cat{sharing} should be embedded in the process of software
development, in order to contribute effectively to the \cat{transparency} category.
...
must be accessible to everyone, in order to foment \cat{transparency}.
