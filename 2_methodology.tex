\section{Method and Settings}\label{sec:method}
...
\begin{table}[t]
  ...
  \begin{tabular}{rp{10cm}}\toprule
   {\bf Analyze} & {\bf Object under measurement} \\ \midrule
  ...
  \begin{tabular}{rp{10cm}}\toprule
   {\bf Analyze} & {\bf Object under measurement} \\ \midrule
    ...
    \emph{With respect to}    & \emph{the guidance it provides on the activities that
                                might lift the results of a DevOps adoption effort.} \\[0.2cm]
...
%% rbonifacio: I believe that this paragraph is not relevant. 
%% 
