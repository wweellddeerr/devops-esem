\begin{abstract}
  ...
  \emph{ Research Context.} DevOps is a set of practices and cultural values
  ...
  we also report this experience.
...
\begin{IEEEkeywords}
DevOps, Grounded Theory, Software Development, Software Operations
\end{IEEEkeywords}
