\begin{abstract}
  ...
  \emph{Research problem and goal.} Nevertheless, little is
  known about the \emph{practitioners understanding}
  about successful paths for DevOps adoption. The lack of such understanding might
  hinder institutions to adopt DevOps practices. Therefore,
  our goal
  ...
  \emph{DevOps outcome categories}. We provide evidence that \emph{collaboration}
  ...
  \emph{Implications.} Altogether, our results contribute to (a) generating
