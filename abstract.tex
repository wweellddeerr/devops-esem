\begin{abstract}
  Background: DevOps is a set of practices that has gained increasing
  ...
  Aims: However, little is known about the \emph{practitioners understanding}
  about successful paths for DevOps adoption, which might
  hinder institutions to start the use DevOps practices.\\
  Method: Based on a Grounded Theory study, considering 15 well succeeded DevOps
  ...
  Results: We organize this model in terms of \emph{DevOps enabler categories} and
  ...
  achieve DevOps. Based on this understanding, we also report the experience of improving
  ...
  Conclusions: Altogether, our results
